...
from Prism_DaVinciResolve_Functions import Prism_DaVinciResolve_Functions
from Prism_DaVinciResolve_Integration import Prism_DaVinciResolve_Integration


class Prism_Plugin_DaVinciResolve(
    Prism_DaVinciResolve_Variables,
    Prism_DaVinciResolve_externalAccess_Functions,
    Prism_DaVinciResolve_Functions,
    ...
    def __init__(self, core):
        ...
        Prism_DaVinciResolve_Functions.__init__(self, core, self)
