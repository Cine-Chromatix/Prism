...
class Updater(object):
    ...
    def checkForUpdates(self, silent=False):
        ...
        url = "https://raw.githubusercontent.com/Cine-Chromatix/Prism/main/Prism/Scripts/PrismCore.py"
        result = self.getPrismVersionFromGithub(url)

        if not result:
            if not silent:
                msg = "Unable to read https://raw.githubusercontent.com/Cine-Chromatix/Prism/main/Prism/Scripts/PrismCore.py. Could not check for updates."
                self.core.popup(msg)
            self.core.setConfig(
                cat="globals",
                param="update_status",
